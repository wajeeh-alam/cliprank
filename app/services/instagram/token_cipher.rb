...
module Instagram
  # Access tokens are encrypted before they leave the model boundary. The
  # encryption key is derived from SECRET_KEY_BASE and is never persisted.
  class TokenCipher
    PURPOSE = "cliprank/instagram/access-token".freeze
    SALT = "cliprank/instagram/access-token-key".freeze
    ...
    def self.decrypt(ciphertext)
      ...
      raise ConfigurationError, "Instagram access token could not be decrypted"
    end
